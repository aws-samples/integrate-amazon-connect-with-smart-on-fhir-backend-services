...
public class PrivateCA {
    ...
    private PrivateCA(final Optional<PrivateCA> issuerOption, final String commonName, final CertificateAuthorityType type, final Regions region) {
    ...
    public static class Builder {
        ...
        public PrivateCA getOrCreate() {
            return new PrivateCA(Optional.ofNullable(issuer), commonName, type, region);
        }
    }
}
